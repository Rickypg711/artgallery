      ...
      <header className="sticky top-0 z-10 text-white">
        <section className="mx-auto flex max-w-4xl items-center justify-between p-4">
          ...
          <div>
            ...
            >
              <div className="absolute top-4 -mt-0.5 h-1 w-8 rounded bg-amber-400 transition-all duration-500 before:absolute before:h-1 before:w-8 before:-translate-x-4 before:-translate-y-3 before:rounded before:bg-amber-400 before:transition-all before:duration-500 before:content-[''] after:absolute after:h-1 after:w-8 after:-translate-x-4 after:translate-y-3 after:rounded after:bg-amber-400 after:transition-all after:duration-500 after:content-['']"></div>
            </button>
        ...
        >
          <button
            className="text-8xl self-end px-6 text-burntOrange"
            onClick={toggleMobileMenu}
          >
            &times;
          </button>
          ...
          >
            <Link
              href="#hero"
              className="w-full py-6 text-center hover:opacity-90 text-peach"
            >
              Home
            </Link>
            <Link
