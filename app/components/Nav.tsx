      ...
      <header className="sticky top-0 z-10">
        <section className="mx-auto flex max-w-4xl items-center justify-between p-4">
          <h1 className="text-3xl font-medium text-dreamBlue hover:text-burntOrange dark:text-burntOrange dark:hover:text-dreamBlue">
            <Link href="/" className="flex items-center">SueñAI <FaMoon className="ml-2 text-base"/></Link>
          </h1>
          <div>
            <button
              id="hamburger-button"
            ...
            <nav className="hidden md:flex space-x-8 text-xl" aria-label="main">
              <Link href="#rockets" className="hover:opacity-90 text-burntOrange dark:text-dreamBlue hover:text-dreamBlue dark:hover:text-burntOrange">
                Home
              </Link>
              <Link
                href="/about"
              ...
              <Link href="#contact" className="hover:opacity-90 text-burntOrange dark:text-dreamBlue hover:text-dreamBlue dark:hover:text-burntOrange">
                Contact
              </Link>
              <div className="flex items-center space-x-4 md:ml-4">
                <Link href="https://www.instagram.com/ricardoparedesgaytan/ " target="_blank"><FaInstagram className="text-burntOrange dark:text-dreamBlue hover:text-dreamBlue dark:hover:text-burntOrange" /></Link>
